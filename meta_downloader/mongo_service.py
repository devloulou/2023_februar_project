...
class MongoService:
    ...
    def __init__(self):
        self.client = MongoClient(MongoService.db_uri)
    ...
    def delete_movie(self, title):
        return self.collection.delete_one({'title': {"$regex": title, '$options' : 'i'}})
...
if __name__ == '__main__':
    ...
    mongo.insert_movie({'test': 'test value', 'title': 'Alien'})
