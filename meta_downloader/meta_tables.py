...
select_meta = """
select m.title from movie_meta m
"""
...
"""
--- vannak olyan adatbázisok, ahol nagyon rosszul van lefejlesztve
--- az exists: GreenPlum
select * from movie_genre m
where exists (select 1 from movie_meta t 
where lower(title) = 'braveheart'
and m.movie_id = t.id)
